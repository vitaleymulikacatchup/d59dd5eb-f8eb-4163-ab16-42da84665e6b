...
export const metadata: Metadata = {
  title: "Lusui Odyvan - Premium Barbershop & Grooming Services",
  description: "Experience traditional craftsmanship with modern style at Lusui Odyvan. Premium haircuts, beard grooming, and classic shaving services for the distinguished gentleman.",
  keywords: ["barbershop", "haircuts", "beard grooming", "traditional shaving", "men's grooming", "premium barbering"],
  openGraph: {
    title: "Lusui Odyvan - Premium Barbershop & Grooming Services",
    description: "Traditional craftsmanship meets modern style. Premium grooming services for the distinguished gentleman.",
    siteName: "Lusui Odyvan Barbershop",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763972715152-udqq4f5f.jpg",
        alt: "Lusui Odyvan barbershop interior"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Lusui Odyvan - Premium Barbershop",
    description: "Traditional craftsmanship meets modern style",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763972715152-udqq4f5f.jpg"]
  },
  robots: {
    index: true,
    follow: true
